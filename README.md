...
Identify top-selling car models and countries.

Compare sales across different years and deal sizes.
...
Sales by Car Model (Integra, RDX, TLX, MDX)

Sales by Country and Region

Year-wise Sales Trend Analysis

Deal Size Performance (Small, Medium, Large)
...
USA contributed the maximum sales volume.

Medium and Large deal sizes generated most of the revenue.

Sales showed steady growth over the years.
...
Improve dashboard UI and theme.
